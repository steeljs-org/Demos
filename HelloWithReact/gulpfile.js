...
var front_hostname = '127.0.0.1 res.test.cn ';
var back_base = 'server_back'; //模拟后端的文件放置目录
var back_hostname = '127.0.0.1 test.cn'; //后端的HOST，目的是真实模拟后端的页面路由请求，提供出前端可仿真的功能，比如 /index 对应 /html/index.html
...
function dealSrc(isDebug, options) {
    ...
    var lib_concats = {
        'lib/lib.js': ['lib/steel.js', 'lib/debugConfig.js']
    };
